...
(* OASIS_START *)
(* DO NOT EDIT (digest: ae78367115627d754e698debd7df55ba) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_simple", []))];
          ...
          ("optim",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_optim", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("substitute",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_substitute", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["ZZ3"; "ZZ3_sigs"];
                      lib_pack = false;
                      lib_internal_modules = ["ZZ3Utils"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "Z3overlay"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_simple"
                        ]
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "optim.ml"});
               Test
                 ({
                     cs_name = "optim";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_optim"
                        ]
                   });
               Executable
                 ({
                     cs_name = "test_substitute";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "substitute.ml"});
               Test
                 ({
                     cs_name = "substitute";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_substitute"
                        ]
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Z3";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "åÄæPÏIiK­í0\r<\140f\158";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
